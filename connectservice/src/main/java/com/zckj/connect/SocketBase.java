...
public class SocketBase {
    ...
    public void connect(String ip, int port) throws Exception {
        ...
        if (mSocket.isConnected()) {
            ...
            try
            {
                Log.e("Robi", "服务地址: " + mSocket.getInetAddress().toString());
                Log.e("Robi", "本地地址: " + mSocket.getLocalAddress().toString());
                Log.e("Robi", "服务端口: " + mSocket.getPort());
            } catch (Exception e) {
                e.printStackTrace();
            }
        }
        ...
        if (in != null) {
            try {
                ...
                if ((len = in.read(buffer)) > 0) {
                    ...
                    Log.e("Robi", "read :" + new String(tmpBuffer));
                    tmpBuffer = null;
                }
            } catch (Exception e) {
