package com.angcyo.connectadmin.view;
...
import com.angcyo.connectadmin.R;
 ...
 *         2015-1-4
 */
public class IPEditText extends LinearLayout implements View.OnFocusChangeListener {
    ...
    private View containerView;//容器视图
    ...
    public IPEditText(Context context, AttributeSet attrs) {
        ...
        containerView = view.findViewById(R.id.id_layout_container);

        OperatingEditText(context);

        seFocus(mFirstIP);

        mFirstIP.setOnFocusChangeListener(this);
        mSecondIP.setOnFocusChangeListener(this);
        mThirdIP.setOnFocusChangeListener(this);
        mFourthIP.setOnFocusChangeListener(this);
    }
    ...
    protected void textChanged(EditText prevEdit, EditText currentEdit,
        ...
        if (s == null || s.length() <= 0 && Integer.valueOf(beforeText) > 0) {
    ...
    public void setIpText(String ipText) {
        ...
        mFirstIP.setText(ip[0].toString());
        mSecondIP.setText(ip[1].toString());
        mThirdIP.setText(ip[2].toString());
        mFourthIP.setText(ip[3].toString());
//        mFirstIP.requestFocus();
    }
    ...
    public void onFocusChange(View v, boolean hasFocus) {
        if (hasFocus) {
            containerView.setBackgroundResource(R.drawable.et_bg_focus);
        } else {
            containerView.setBackgroundResource(R.drawable.et_bg_normal);
        }
    }
}
